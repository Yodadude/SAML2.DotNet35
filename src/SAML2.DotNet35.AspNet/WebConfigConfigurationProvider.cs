using SAML2.DotNet35.AspNet.Config;
...
namespace SAML2.DotNet35.AspNet
{
    public class WebConfigConfigurationProvider : IConfigurationProvider
    {
        ...
        private SAML2.DotNet35.Config.Attribute ToAttribute(AttributeElement value)
        {
            if (value == null) return null;
            return new SAML2.DotNet35.Config.Attribute
            {
