...
using SAML2.DotNet35;
using SAML2.DotNet35.Bindings;
...
namespace Owin.Security.Saml
{
    public class SamlMessage : AuthenticationProtocolMessage
    {
        ...
        public SamlMessage(IFormCollection form, IOwinContext context, SAML2.DotNet35.Config.Saml2Configuration config)
            : this(form)
        {
        ...
        {
            string rc = null;
            var logger = SAML2.DotNet35.Logging.LoggerProvider.LoggerFor(typeof(SamlMessage));
        ...
        private string AuthnRequestForIdp(IdentityProvider identityProvider, Saml20AuthnRequest request, IOwinContext context, Saml2Configuration config)
        {
            ...
            case BindingType.Artifact:
                ...
                //break;
            default:
                logger.Error(SAML2.DotNet35.ErrorMessages.EndpointBindingInvalid);
                throw new Saml20Exception(SAML2.DotNet35.ErrorMessages.EndpointBindingInvalid);
            }
            throw new NotImplementedException();
        }
