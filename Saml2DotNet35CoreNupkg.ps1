param(
	[string]$project = ".\src\SAML2.DotNet35.Core\SAML2.DotNet35.Core.csproj",
	[string]$solution = ".\src\SAML2.DotNet35.sln",
	[string]$assemblyInfoFile = ".\src\SAML2.DotNet35.Core\Properties\AssemblyInfo.cs",
	[string]$nuspecFile = ".\src\SAML2.DotNet35.Core\SAML2.DotNet35.Core.nuspec"
)
